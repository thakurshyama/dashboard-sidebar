...
function GetApi() {
  ...
  const [isModalOpenreject2, setIsModalOpenreject2] = useState(false);
  const [isModalOpenreject3, setIsModalOpenreject3] = useState(false);
    ...
    const fetchUsers = async () => {
      try {
        ...
        const res = await axios.get(
          `http://139.59.60.119:4777/v1/order/outlets?status=cancelled&from=2023-01-19&to=${d.toDateString()}`,
  ...
  const handleOpenModal2 = (user) => {
    setUserData(user);
    setIsModalOpenreject2(true);
  };
  const handleOk2 = () => {
    setIsModalOpenreject2(false);
  };
  ...
  const handleOpenModal3 = (user) => {
    setUserData(user);
    setIsModalOpenreject3(true);
  };
  const handleOk3 = () => {
    setIsModalOpenreject3(false);
  };
  ...
  return (
    <div className='New'>
      ...
      <Modal title='User Information' open={isModalOpenreject} onOk={handleOk} onCancel={handleCloseModal}>
        {userData && (
          <div>
            <p>
      ...
      <Modal title='User Information' open={isModalOpenreject2} onOk={handleOk2} onCancel={handleCloseModal2}>
        {userData && (
          <div>
            <p>
      ...
      <Modal title='User Information' open={isModalOpenreject3} onOk={handleOk3} onCancel={handleCloseModal3}>
        {userData && (
          <div>
            <p>
